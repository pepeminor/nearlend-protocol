...
const BIG_DIVISOR: u128 = 10u128.pow(NUM_DECIMALS as u32); // ray: a fixed point integer, with 27 decimal places.
const HALF_DIVISOR: u128 = BIG_DIVISOR / 2; // half of ray
...
impl BigDecimal {
    pub fn from_ratio(ratio: u32) -> Self {
        //TODO: target_utilization * (10^27 / 10000) ?
