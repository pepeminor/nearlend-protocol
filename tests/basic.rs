...
use contract::{BigDecimal, SECOND_PER_YEAR};

const SEC_PER_YEAR: u32 = (SECOND_PER_YEAR / 1000) as u32;
...
fn test_borrow_and_withdraw() {
    ...
    assert_eq!(asset.supply_apy, BigDecimal::zero());
...
fn test_interest() {
    ...
    let asset = e.get_asset(&tokens.ndai);
    assert_eq!(asset.borrowed.balance, borrow_amount);
    assert_relative_eq!(asset.borrow_apy.f64(), 0.08f64);
