...
near_sdk_sim::lazy_static_include::lazy_static_include_bytes! {
    ...
    NEARLEND_0_1_0_WASM_BYTES => "res/nearlend.wasm",
    TEST_ORACLE_WASM_BYTES => "res/test_oracle.wasm",
    FUNGIBLE_TOKEN_WASM_BYTES => "res/fungible_token.wasm",
}

pub fn nearlend_0_1_0_wasm_bytes() -> &'static [u8] {
    &NEARLEND_0_1_0_WASM_BYTES
}
...
impl Env {
    ...
    pub fn redeploy_latest(&self) {
        self.contract
            ...
            .deploy_contract(NEARLEND_WASM_BYTES.to_vec())
            .submit()
            .assert_success();
    }
